...
- [[Upload rebuilt packs]] — **do this before the new previews go live**
...
All five coloring packs are generated by `tools/packlib/` — 150 pages of black
vector line art, deterministic, verified on every build. The built PDFs land in
`assets/packs/`, which is **gitignored**: they are the paid goods and this repo
is public.

```bash
python3 tools/build_packs.py            # build and verify all five
